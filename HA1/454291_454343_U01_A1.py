...
# 1 d)
cdfAt3p5 = stats.norm.cdf(3.5, mu, sigma)
bigger3p5freq = len([v for v in a if v > 3.5])/len(a)
print(1-cdfAt3p5)
print(f'Stimmt das Modell, dass die Messwerte mit mu und sigma normalverteilt sind, sollten {1-cdfAt3p5:.2f}% der Werte über 3,5 liegen.')
print(f'In unserere Stichprobe liegen {bigger3p5freq:.2f}% der Werte über 3,5.')